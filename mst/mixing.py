...
def knowledge_engineering_mix(
    ...
    #print("mdata:", mdata)
    ke_mixconsole_dir = "/homes/ssv02/Diff-MST/mst/data/mixing_console_configs/KE_mix_console.yaml"
    with open(ke_mixconsole_dir, 'r') as f:
        ...
        for i in range(len(metadata)):
            ...
            if stereo_info[i] == 1:
                if i == num_tracks-1:
                    ...
                    skip = True
            #print(metadata[i])
            inst_key = [key for key in inst_keys if metadata[i] in KE[key]['instruments']] 
            if inst_key == []:
            ...
            mix_params[j, i, 0] = random.uniform(KE[inst_key[0]]['gain'][0],KE[inst_key[0]]['gain'][1])
            if not mix_console.param_ranges['input_gain']['gain_db'][0] <= mix_params[j, i, 0] <= mix_console.param_ranges['input_gain']['gain_db'][1]:
                #raise value error
            ...
            if not mix_console.param_ranges['stereo_panner']['pan'][0] <= pan_params[j, i, 0] <= mix_console.param_ranges['stereo_panner']['pan'][1]:    
                #raise value error
            ...
            if advance_console:
                ...
                eq_lowshelf_params[j,i,0] = random.uniform(KE[inst_key[0]]['eq']['eq_lowshelf_gain'][0], KE[inst_key[0]]['eq']['eq_lowshelf_gain'][1])
                if not mix_console.param_ranges['parametric_eq']['low_shelf_gain_db'][0] <= eq_lowshelf_params[j,i,0] <= mix_console.param_ranges['parametric_eq']['low_shelf_gain_db'][1]:
                    #raise value error
                    print(eq_lowshelf_params[j,i,0])
                    print("eq_lowshelf_gain value out of range")
                
                eq_lowshelf_params[j,i,1] = random.uniform(KE[inst_key[0]]['eq']['eq_lowshelf_freq'][0], KE[inst_key[0]]['eq']['eq_lowshelf_freq'][1])
                if not mix_console.param_ranges['parametric_eq']['low_shelf_cutoff_freq'][0] <= eq_lowshelf_params[j,i,1] <= mix_console.param_ranges['parametric_eq']['low_shelf_cutoff_freq'][1]:
                    #raise value error
                    print(eq_lowshelf_params[j,i,1])
                    print("eq_lowshelf_freq value out of range")
                
                eq_lowshelf_params[j,i,2] = random.uniform(KE[inst_key[0]]['eq']['eq_lowshelf_q'][0], KE[inst_key[0]]['eq']['eq_lowshelf_q'][1])
                if not mix_console.param_ranges['parametric_eq']['low_shelf_q_factor'][0] <= eq_lowshelf_params[j,i,2] <= mix_console.param_ranges['parametric_eq']['low_shelf_q_factor'][1]:
                    #raise value error
                    print(eq_lowshelf_params[j,i,2])
                    print("eq_lowshelf_q value out of range")
                
                eq_bandpass0_params[j,i,0] = random.uniform(KE[inst_key[0]]['eq']['eq_band0_gain'][0], KE[inst_key[0]]['eq']['eq_band0_gain'][1])
                if not mix_console.param_ranges['parametric_eq']['band0_gain_db'][0] <= eq_bandpass0_params[j,i,0] <= mix_console.param_ranges['parametric_eq']['band0_gain_db'][1]:
                    #raise value error
                    print(eq_bandpass0_params[j,i,0])
                    print("eq_band0_gain value out of range")
                
                eq_bandpass0_params[j,i,1] =random.uniform(KE[inst_key[0]]['eq']['eq_band0_freq'][0], KE[inst_key[0]]['eq']['eq_band0_freq'][1])
                if not mix_console.param_ranges['parametric_eq']['band0_cutoff_freq'][0] <= eq_bandpass0_params[j,i,1] <= mix_console.param_ranges['parametric_eq']['band0_cutoff_freq'][1]:
                    #raise value error
                    print(eq_bandpass0_params[j,i,1])
                    print("eq_band0_freq value out of range")
                
                eq_bandpass0_params[j,i,2] =random.uniform(KE[inst_key[0]]['eq']['eq_band0_q'][0], KE[inst_key[0]]['eq']['eq_band0_q'][1])
                if not mix_console.param_ranges['parametric_eq']['band0_q_factor'][0] <= eq_bandpass0_params[j,i,2] <= mix_console.param_ranges['parametric_eq']['band0_q_factor'][1]:
                    #raise value error
                    print(eq_bandpass0_params[j,i,2])
                    print("eq_band0_q value out of range")
                
                eq_bandpass1_params[j,i,0] =random.uniform(KE[inst_key[0]]['eq']['eq_band1_gain'][0], KE[inst_key[0]]['eq']['eq_band1_gain'][1])
                if not mix_console.param_ranges['parametric_eq']['band1_gain_db'][0] <= eq_bandpass1_params[j,i,0] <= mix_console.param_ranges['parametric_eq']['band1_gain_db'][1]:
                    #raise value error
                    print(eq_bandpass1_params[j,i,0])
                    print("eq_band1_gain value out of range")
                
                eq_bandpass1_params[j,i,1] = random.uniform(KE[inst_key[0]]['eq']['eq_band1_freq'][0], KE[inst_key[0]]['eq']['eq_band1_freq'][1])
                if not mix_console.param_ranges['parametric_eq']['band1_cutoff_freq'][0] <= eq_bandpass1_params[j,i,1] <= mix_console.param_ranges['parametric_eq']['band1_cutoff_freq'][1]:
                    #raise value error
                    print(eq_bandpass1_params[j,i,1])
                    print("eq_band1_freq value out of range")
                
                eq_bandpass1_params[j,i,2] = random.uniform(KE[inst_key[0]]['eq']['eq_band1_q'][0], KE[inst_key[0]]['eq']['eq_band1_q'][1])
                if not mix_console.param_ranges['parametric_eq']['band1_q_factor'][0] <= eq_bandpass1_params[j,i,2] <= mix_console.param_ranges['parametric_eq']['band1_q_factor'][1]:
                    #raise value error
                    print(eq_bandpass1_params[j,i,2])
                    print("eq_band1_q value out of range")
            
                eq_bandpass2_params[j,i,0] = random.uniform(KE[inst_key[0]]['eq']['eq_band2_gain'][0], KE[inst_key[0]]['eq']['eq_band2_gain'][1])
                if not mix_console.param_ranges['parametric_eq']['band2_gain_db'][0] <= eq_bandpass2_params[j,i,0] <= mix_console.param_ranges['parametric_eq']['band2_gain_db'][1]:
                    #raise value error
                    print(eq_bandpass2_params[j,i,0])
                    print("eq_band2_gain value out of range")
                
                eq_bandpass2_params[j,i,1] = random.uniform(KE[inst_key[0]]['eq']['eq_band2_freq'][0], KE[inst_key[0]]['eq']['eq_band2_freq'][1])
                if not mix_console.param_ranges['parametric_eq']['band2_cutoff_freq'][0] <= eq_bandpass2_params[j,i,1] <= mix_console.param_ranges['parametric_eq']['band2_cutoff_freq'][1]:
                    #raise value error
                    print(eq_bandpass2_params[j,i,1])
                    print("eq_band2_freq value out of range")
                
                eq_bandpass2_params[j,i,2] = random.uniform(KE[inst_key[0]]['eq']['eq_band2_q'][0], KE[inst_key[0]]['eq']['eq_band2_q'][1])
                if not mix_console.param_ranges['parametric_eq']['band2_q_factor'][0] <= eq_bandpass2_params[j,i,2] <= mix_console.param_ranges['parametric_eq']['band2_q_factor'][1]:
                    #raise value error
                    print(eq_bandpass2_params[j,i,2])
                    print("eq_band2_q value out of range")

                eq_bandpass3_params[j,i,0] = random.uniform(KE[inst_key[0]]['eq']['eq_band3_gain'][0], KE[inst_key[0]]['eq']['eq_band3_gain'][1])
                if not mix_console.param_ranges['parametric_eq']['band3_gain_db'][0] <= eq_bandpass3_params[j,i,0] <= mix_console.param_ranges['parametric_eq']['band3_gain_db'][1]:
                    #raise value error
                    print(eq_bandpass3_params[j,i,0])
                    print("eq_band3_gain value out of range")
                
                eq_bandpass3_params[j,i,1] = random.uniform(KE[inst_key[0]]['eq']['eq_band3_freq'][0], KE[inst_key[0]]['eq']['eq_band3_freq'][1])
                if not mix_console.param_ranges['parametric_eq']['band3_cutoff_freq'][0] <= eq_bandpass3_params[j,i,1] <= mix_console.param_ranges['parametric_eq']['band3_cutoff_freq'][1]:
                    #raise value error
                    print(eq_bandpass3_params[j,i,1])
                    print("eq_band3_freq value out of range")
                
                eq_bandpass3_params[j,i,2] = random.uniform(KE[inst_key[0]]['eq']['eq_band3_q'][0], KE[inst_key[0]]['eq']['eq_band3_q'][1])
                if not mix_console.param_ranges['parametric_eq']['band3_q_factor'][0] <= eq_bandpass3_params[j,i,2] <= mix_console.param_ranges['parametric_eq']['band3_q_factor'][1]:
                    #raise value error
                    print(eq_bandpass3_params[j,i,2])
                    print("eq_band3_q value out of range")

                eq_highshelf_params[j,i,0] = random.uniform(KE[inst_key[0]]['eq']['eq_highshelf_gain'][0], KE[inst_key[0]]['eq']['eq_highshelf_gain'][1])
                if not mix_console.param_ranges['parametric_eq']['high_shelf_gain_db'][0] <= eq_highshelf_params[j,i,0] <= mix_console.param_ranges['parametric_eq']['high_shelf_gain_db'][1]:
                    #raise value error
                    print(eq_highshelf_params[j,i,0])
                    print("eq_highshelf_gain value out of range")
                
                eq_highshelf_params[j,i,1] =random.uniform(KE[inst_key[0]]['eq']['eq_highshelf_freq'][0], KE[inst_key[0]]['eq']['eq_highshelf_freq'][1])
                if not mix_console.param_ranges['parametric_eq']['high_shelf_cutoff_freq'][0] <= eq_highshelf_params[j,i,1] <= mix_console.param_ranges['parametric_eq']['high_shelf_cutoff_freq'][1]:
                    #raise value error
                    print(eq_highshelf_params[j,i,1])
                    print("eq_highshelf_freq value out of range")
                
                eq_highshelf_params[j,i,2] = random.uniform(KE[inst_key[0]]['eq']['eq_highshelf_q'][0], KE[inst_key[0]]['eq']['eq_highshelf_q'][1])
                if not mix_console.param_ranges['parametric_eq']['high_shelf_q_factor'][0] <= eq_highshelf_params[j,i,2] <= mix_console.param_ranges['parametric_eq']['high_shelf_q_factor'][1]:
                    #raise value error
                    print(eq_highshelf_params[j,i,2])
                    print("eq_highshelf_q value out of range")
                

                comp_params[j,i,0] = random.uniform(KE[inst_key[0]]['compressor']['threshold_db'][0], KE[inst_key[0]]['compressor']['threshold_db'][1])
                if not mix_console.param_ranges['compressor']['threshold_db'][0] <= comp_params[j,i,0] <= mix_console.param_ranges['compressor']['threshold_db'][1]:
                    #raise value error
                    print(comp_params[j,i,0])
                    print("comp_threshold value out of range")
                
                comp_params[j,i,1] =random.uniform(KE[inst_key[0]]['compressor']['ratio'][0], KE[inst_key[0]]['compressor']['ratio'][1])
                if not mix_console.param_ranges['compressor']['ratio'][0] <= comp_params[j,i,1] <= mix_console.param_ranges['compressor']['ratio'][1]:
                    #raise value error
                    print(comp_params[j,i,1])
                    print("comp_ratio value out of range")
                
                comp_params[j,i,2] = random.uniform(KE[inst_key[0]]['compressor']['attack_ms'][0], KE[inst_key[0]]['compressor']['attack_ms'][1])
                if not mix_console.param_ranges['compressor']['attack_ms'][0] <= comp_params[j,i,2] <= mix_console.param_ranges['compressor']['attack_ms'][1]:
                    #raise value error
                    print(comp_params[j,i,2])
                    print("comp_attack value out of range")
                
                comp_params[j,i,3] = comp_params[j,i,2]
                if not mix_console.param_ranges['compressor']['release_ms'][0] <= comp_params[j,i,3] <= mix_console.param_ranges['compressor']['release_ms'][1]:
                    #raise value error
                    print(comp_params[j,i,3])
                    print("comp_release value out of range")
                
                comp_params[j,i,4] = random.uniform(KE[inst_key[0]]['compressor']['knee_db'][0], KE[inst_key[0]]['compressor']['knee_db'][1])
                if not mix_console.param_ranges['compressor']['knee_db'][0] <= comp_params[j,i,4] <= mix_console.param_ranges['compressor']['knee_db'][1]:
                    #raise value error
                    print(comp_params[j,i,4])
                    print("comp_knee value out of range")
                
                comp_params[j,i,5] = random.uniform(KE[inst_key[0]]['compressor']['makeup_gain_db'][0], KE[inst_key[0]]['compressor']['makeup_gain_db'][1])
                if not mix_console.param_ranges['compressor']['makeup_gain_db'][0] <= comp_params[j,i,5] <= mix_console.param_ranges['compressor']['makeup_gain_db'][1]:
                    #raise value error
